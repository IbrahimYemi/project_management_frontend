    ...
    return (
        <AppLayout>
            <div className="min-w-screen min-h-screen bg-black flex items-center p-5 lg:p-20 overflow-hidden relative">
                <div className="flex-1 min-h-full min-w-full rounded-3xl bg-black shadow-xl p-10 lg:p-20 text-gray-800 relative md:flex items-center text-center md:text-left">
                    <div className="w-full md:w-1/2">
                        <div className="mb-10 md:mb-20 text-titleText font-light">
                            <h1 className="font-black uppercase text-3xl lg:text-5xl text-brand mb-10">
                                You seem to be lost!
                            </h1>
                            <p>
